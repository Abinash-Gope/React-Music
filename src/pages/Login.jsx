...
const Login = () => {
  ...
  const submitHandler = (data) => {
    ...
    if (user) {
      alert(`Welcome back, ${user.fullName || user.userName || 'User'}!`)
      navigate('/')
    } else {
  ...
  return (
    <div className="font-body-md text-body-md antialiased min-h-screen">
      <main className="flex min-h-screen flex-col md:flex-row">
        ...
        <section className="hidden md:flex md:w-1/2 relative bg-surface-container-lowest items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-lg p-lg floating-anim">
            <img
              className="w-full h-auto drop-shadow-2xl"
              alt="High-end 3D digital illustration of premium metallic headphones"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBgn3rQzrSgqR7k30K6b0JuA3Jy5P2q-2ZK_sDNEZRk21J6TNyO2PTGPKr0buZ_tlO_r3k7vDycUR_BZCM1-8DnE0XQIiT1jpGBwmd-QulMFc7y5bBbJBI0dzL1TGlHiqAhSy2f8Au6XlPCVKVzLJzFezsj-wWORNecdTEIxbuElWvhsvclwffr1mQ6zy4k0zZ8SL57lxZhOALHv0FMh1x5mjEsNknjW0EQDk2pArOLWZ0xPCPaL0WfdwYPwNMytMQFnXFfjrZqAY0"
            />
            <div className="mt-lg text-center space-y-xs">
              <h2 className="font-display-lg text-display-lg text-primary">MusicHub</h2>
          ...
          <div className="absolute top-20 right-20 text-primary/30 rotate-12">
            <span className="material-symbols-outlined !text-6xl">music_note</span>
          </div>
          <div className="absolute bottom-40 left-20 text-tertiary/20 -rotate-12">
        ...
        <section className="flex-1 flex items-center justify-center p-margin-mobile md:p-margin-desktop bg-[#0F0F0F] relative">
          ...
          <div className="glass-card w-full max-w-[440px] rounded-xl p-md md:p-lg">
            ...
            <form className="space-y-md" onSubmit={handleSubmit(submitHandler)}>
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M12 5.04c1.94 0 3.51.68 4.75 1.81l3.51-3.51C18.17 1.34 15.36 0 12 0 7.31 0 3.32 2.67 1.32 6.56l4.08 3.16C6.38 6.94 8.94 5.04 12 5.04z" fill="#EA4335" />
                  <path d="M23.49 12.27c0-.79-.07-1.54-.19-2.27H12v4.51h6.47c-.29 1.48-1.14 2.73-2.4 3.58l3.89 3.01c2.27-2.11 3.53-5.22 3.53-8.83z" fill="#4285F4" />
                  <path d="M5.4 14.71c-.24-.73-.37-1.5-.37-2.31s.13-1.58.37-2.31L1.32 6.56C.48 8.19 0 10.04 0 12s.48 3.81 1.32 5.44l4.08-3.16z" fill="#FBBC05" />
                  <path d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.89-3.01c-1.11.75-2.52 1.19-4.04 1.19-3.06 0-5.62-1.9-6.56-4.68l-4.08 3.16C3.32 21.33 7.31 24 12 24z" fill="#34A853" />
                </svg>
            ...
            <div className="mt-lg pt-md border-t border-white/5 text-center">
              <p className="font-body-md text-on-surface-variant">
                ...
                <Link to="/register" className="text-primary font-medium hover:underline ml-xs transition-all">
                  Register
                </Link>
              </p>
            </div>
          ...
          <div className="absolute bottom-8 right-margin-desktop opacity-5 select-none pointer-events-none hidden md:block">
            <span className="font-display-lg text-[120px] font-extrabold uppercase leading-none">Vibe</span>
          </div>
        </section>
      </main>
    </div>
